...
这个线索直到明确了自己的定位才终于明了。如果我对自己的定位，就是一个会一些主流前端技能、有一点产品经理思维、主要用 PHP 写后端的 web 开发者的话，那为什么不以一个 web 服务开发所需要的知识作为线索来组织呢。

所以，我就开始写东西了。整体的思路是在理清楚一个 web 服务所需要的基本构成之后，沿着数据流动的方向一点一点的描述。和“在浏览器输入地址，按下 Enter 之后发生了什么”差不多，不过会尽量从开发的角度来组织内容。

此事优先级已经被我拉到了个人事务的最高等级。
